...
/* unixconn.c:69:NF */ extern const char *unixconn_make (unixconn_t **rv, int slot, const char *path, const char *remote, asio_event_handler_t handler, void (*finalize)(void *uct)); /* (rv, slot, path, remote, handler) unixconn_t **rv; int slot; const char *path; const char *remote; asio_event_handler_t handler; */
